    ...
    return (
      <div className="container page displayhandbook">
        <div>
          <h2> Register</h2>
          <p>
          This is for the user when they visit our site for the 1st time and want to use it.
            The user needs to register by providing Name, Email and Password.<br></br>
            Once the user has registered, they will be able to access certain features and content on the site.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            order to successfully login into the application.<br></br>
            After logging in, the user will have access to their account and any saved data or preferences.
          </p>
        </div>
